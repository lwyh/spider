...
url = 'https://www.zhipin.com/web/geek/job?query=BI%E5%BC%80%E5%8F%91%E5%B7%A5%E7%A8%8B%E5%B8%88&city=101280600'
headers = {
    'authority':'static.zhipin.com',
    'method':'GET',
    'path': '/fe-zhipin-geek/web/chat/v5674/static/js/job.11a4058d.js',
    'scheme': 'https',
    'Accept' : '*/*',
